...
/*                $subcredits ="select * from subscriptions where id = '$subscription_id'";
        ...
        echo $getsf = "select * from franchise_users where frcode= '$sfrcode'";
        ...
        if (mysqli_num_rows($resgetsf) > 0)
        {
            ...
            echo $sfcom = "insert into frachise_accounts (user_id,franchise_id,amount,payment_for,payment_date,status) values ('$userid','$sfranchise_id','$sfamount','subscription','$payment_date','0')";
        ...
        if (mysqli_num_rows($resgetcf) > 0)
        {
            ...
            $payment_date = date("Y-m-d");
            echo $cfcom = "insert into frachise_accounts (user_id,franchise_id,amount,payment_for,payment_date,status) values ('$userid','$franchise_id','$cfamount','upgrade','$payment_date','0')";
