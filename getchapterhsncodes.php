...
if (isset($_SERVER['HTTP_ORIGIN'])) {
	...
	//	$sql = "select hscode,english,policy,CONCAT('chapter No:', chapter_id,'---HSCode:',hscode,'------', english ,'---- Policy:', policy) AS MyColumn from $table_name where  chapter_id = '$chapter_id'";
